import sys
sys.path.append('..')
from reward_train import RewardTrainer
from reward_config import TrainParams
from reward_data import load_data
import torch
...
def main():
    ...
    parser.add_argument('--multi_task_beta', type=float)
